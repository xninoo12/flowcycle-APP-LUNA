...
/// Top header for Fertility subscreen with back button, pink lotus flower accent, and action buttons.
class FertilityHeader extends StatelessWidget {
  final VoidCallback? onBackTap;
  final VoidCallback? onCalendarTap;
  final VoidCallback? onMoreTap;

  const FertilityHeader({
    super.key,
    this.onBackTap,
    this.onCalendarTap,
    this.onMoreTap,
