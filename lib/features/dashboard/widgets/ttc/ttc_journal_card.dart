...
/// TTC Daily check-in and mood/energy logging entry point card.
class TtcJournalCard extends StatelessWidget {
  final VoidCallback? onPromptTap;
  final VoidCallback? onAddTap;

  const TtcJournalCard({super.key, this.onPromptTap, this.onAddTap});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // 3. Glowing Pink Plus Action Button
          GestureDetector(
